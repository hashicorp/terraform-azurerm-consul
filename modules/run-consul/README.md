...
module](https://github.com/gruntwork-io/terraform-consul-azure/modules/install-consul). The default install path is `/opt/consul/bin`, so to start Consul in server mode, 
you run:
